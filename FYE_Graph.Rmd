...
#Assign to variable so modifications are easier
...
```{r}
#Start changing plot to make it look nice, edits in these to address the following in order:
#angle/ dates , remove minor axis lines, remove legend background, center title, 
#resize axis, resize ledgend text,
